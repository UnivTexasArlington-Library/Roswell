...
<?php endif; ?>
  ...
  <!-- /#Photo-Panel-->
<?php if (!empty($page['panel_1']) || !empty($page['panel_2']) || !empty($page['panel_3']) || !empty($page['panel_4'])): ?>
    <div class="well well-lg">
      <div class="row">
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 third-col">
          <div class="panel-grid">
             <div class="panel-inner-grid">
...
<?php endif; ?>
  ...
  <div class="well well-lg"><!-- /#Main Content-->
     <div class="row">
      <?php if (!empty($page['sidebar_first'])): ?>
          <aside class="col-lg-3 hidden-md hidden-sm hidden-xs" role="complementary">
      ...
      <?php if (!empty($page['sidebar_first'])): ?>
        <aside class="hidden-lg col-md-12 col-sm-12 col-xs-12" role="complementary">
          <?php print render($page['sidebar_first']); ?>
